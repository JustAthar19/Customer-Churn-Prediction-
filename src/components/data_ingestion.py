'''
This script is utilized for reading the dataset and splitting it into training and test set. The results from this script is necessary for the data transofrmation component
'''
